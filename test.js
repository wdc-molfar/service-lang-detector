...
const run = async () => {
	...
	console.log(new Date(),"Test run @molfar/service-lang-detector")
	...
	container.hold(servicePath, "@molfar/lang-detector")
	const service = await container.startInstance(container.getService(s => s.name == "@molfar/lang-detector"))
